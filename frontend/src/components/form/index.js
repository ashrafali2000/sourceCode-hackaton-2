...
export const FormComponent = ({ signUp, singUpHandler, singInHandler }) => {
  ...
  return (
    <>
      <section className="bg-white dark:bg-gray-900">
        <div className="container flex pt-16 justify-center min-h-screen px-6 mx-auto">
            ...
            <div className="flex items-center justify-center mt-6">
              <Link
                ...
                className={`w-1/3 pb-4 font-medium text-center text-gray-800 capitalize ${
                  !signUp ? "border-b-2 border-blue-400" : "border-b"
                } `}
              >
                sign in
              </Link>
